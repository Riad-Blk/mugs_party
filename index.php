...
$color = array("Noir", "blanc", "violet", "Marron", "Rose", "Vert", "Jaune");
$len = count($color);
  for($i = 0; $i < $len; $i++) {
    echo $color[$i];
    echo "<br>";
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="/"><?= $titre; ?><span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item active">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-sm-6 footer-box">
                        <p style="padding-right:80px;"><h4><?= $titre; ?>.</h4>On y trouve de tout et surtout du n'importe quoi !!</p>
                        ...
                        <ul class="contact-info">
                            <li><span class="icon fa fa-home"></span><?= $titre; ?>, 67000 Strasbourg</li>
                    ...
                    <div class="col-md-12 footer-box">
                        <div class="copyright">
                        <p>&copy; <?= $titre; ?> 2021. Tous droits réservés.</p>
                        </div>
                    </div>
                </div>
            </div>
